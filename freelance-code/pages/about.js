  ...
  return (
    <Layout>
      ...
      <div className="max-w-m mx-auto text-sm text-black bg-white shadow-md rounded-md overflow-hidden p-4 sm:p-10">
        <div className="mb-6">
          <p className="mb-2"><strong>Welcome to our website! </strong>We are Golde, Katie and Shauni and we are so glad you stopped by. Here is a little bit about us:</p>
              ...
              <div>
                <div className="flex content-center h-10">
                  <div className="grid place-items-center py-1 pr-1">
                    ...
                    <a className="underline text-coBlue h-10 p-2" href={`https://github.com/goldet`} rel="noreferrer" target="_blank" >https://github.com/goldet</a>
                </div>
                <div className="flex content-center h-10">
                  <div className="grid place-items-center py-1 pr-1"><FaLinkedin className="text-xl"/></div>
                  <a className="underline text-coBlue h-10 p-2" href={`https://www.linkedin.com/`} rel="noreferrer" target="_blank" >https://www.linkedin.com/</a>
                </div>
              </div>
          </div>
          <div className="flex flex-row sm:flex-col">
